...
LogicSystem::LogicSystem()
{
    ...
    RegPost("/user_login", [](std::shared_ptr<HttpConnection> connection) {
        ...
        // M2: forward AgentServer endpoint if StatusServer picked one.
        // agent_host == "" signals "AI features disabled" on this deploy —
        // client sees empty string and hides the AI panel.
        root["agent_host"] = reply.agent_host();
        root["agent_port"] = reply.agent_port();
        std::string jsonstr = root.toStyledString();
        beast::ostream(connection->_response.body()) << jsonstr;
        return true;
