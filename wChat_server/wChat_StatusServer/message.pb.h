...
class AddFriendReq PROTOBUF_FINAL :
 ...
 public:
  ...
  // int32 applyid = 1;
  void clear_applyid();
  ::PROTOBUF_NAMESPACE_ID::int32 applyid() const;
  void set_applyid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_applyid() const;
  void _internal_set_applyid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 applyid_;
...
// int32 applyid = 1;
inline void AddFriendReq::clear_applyid() {
  applyid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AddFriendReq::_internal_applyid() const {
  return applyid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AddFriendReq::applyid() const {
  // @@protoc_insertion_point(field_get:message.AddFriendReq.applyid)
  return _internal_applyid();
}
inline void AddFriendReq::_internal_set_applyid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  applyid_ = value;
}
inline void AddFriendReq::set_applyid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_applyid(value);
  // @@protoc_insertion_point(field_set:message.AddFriendReq.applyid)
}
