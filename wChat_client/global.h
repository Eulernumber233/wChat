...
enum ReqId{
    ...
    ID_HEARTBEAT_RSP = 1024,       //心跳回复 TODO ?
    ...
    ID_NOTIFY_KICK_USER       = 1031, // Server→Client: 被踢下线（重复登录等）
...
struct MsgInfo{
    QString msgFlag;// text,image,Files
    QString content; // 文件图像的url
    QPixmap pixmap; // 文件图片缩略图
};

extern QString gate_url_prefix;
extern QString gate_url_prefix_domain;
