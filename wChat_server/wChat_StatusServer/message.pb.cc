...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::AddFriendReq, applyid_),
...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\t\"J\n\014AddFriendReq\022\017\n\007applyid\030\001 \001(\005\022\014\n\004na"
  ...
  " \001(\005\022\'\n\010textmsgs\030\003 \003(\0132\025.message.TextCha"
...
AddFriendReq::AddFriendReq(const AddFriendReq& from)
  ...
  ::memcpy(&applyid_, &from.applyid_,
    ...
    reinterpret_cast<char*>(&applyid_)) + sizeof(touid_));
...
::PROTOBUF_NAMESPACE_ID::uint8* AddFriendReq::_InternalSerialize(
  ...
  if (this->applyid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_applyid(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:message.AddFriendReq)
  ...
  if (from.applyid() != 0) {
    _internal_set_applyid(from._internal_applyid());
  }
  if (from.touid() != 0) {
...
void AddFriendReq::InternalSwap(AddFriendReq* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(AddFriendReq, applyid_)>(
          reinterpret_cast<char*>(&applyid_),
          reinterpret_cast<char*>(&other->applyid_));
}
