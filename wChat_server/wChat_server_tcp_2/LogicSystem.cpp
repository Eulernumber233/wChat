...
void LogicSystem::AuthFriendApply(std::shared_ptr<CSession> session, const short& msg_id, const string& msg_data) {
	...
	auto uid = root["fromuid"].asInt();// 受邀方uid
	auto touid = root["touid"].asInt();// 邀请方uid
	auto back_name = root["back"].asString();// 受邀方给邀请方的昵称
	...
	auth_req.set_fromuid(uid);// 受邀方uid
	auth_req.set_touid(touid);// 邀请方uid
